    ...
    def test_sidecars_results_to_long_valid(self):
        with self.app.app_context():
            ...
            self.assertEqual(
                ...
                "To long of a valid sidecar has a valid status code",
            )
    ...
    def test_sidecars_results_to_long_invalid(self):
        with self.app.app_context():
            ...
            self.assertEqual(
                200,
                response.status_code,
                "Conversion of an invalid sidecar to long has valid status",
            )
            headers_dict = dict(response.headers)
            self.assertEqual(
                "warning",
    ...
    def test_sidecars_results_to_short_valid(self):
        with self.app.app_context():
            ...
            self.assertEqual(
                200,
                response.status_code,
                "To short of a valid sidecar has a valid status code",
            )
            headers_dict = dict(response.headers)
            self.assertEqual(
                "success",
    ...
    def test_sidecars_results_validate_valid(self):
        with self.app.app_context():
            ...
            self.assertEqual(
                200,
                response.status_code,
                "Validation of a valid sidecar has a valid status code",
            )
            headers_dict = dict(response.headers)
            self.assertEqual(
                "success",
    ...
    def test_sidecars_results_to_short_invalid(self):
        with self.app.app_context():
            ...
            self.assertEqual(
                200,
                response.status_code,
                "Conversion of invalid sidecar to short has valid status",
            )
            headers_dict = dict(response.headers)
            self.assertEqual(
                "warning",
